...
<body>
    <div class="container">
        <div class="col-md-5">
            ...
            @endif
            <form class="form-vertical" role="form" method="post" action="{{route('post.store')}}">
                {{csrf_field()}}
                <div class="form-group">
                    <input type="text" name="title" class="form-control" placeholder="Title">
                </div>
                <div class="form-group">
                    <textarea class="form-control" rows="5" name="body" class="form-control"
                    ...
                    <tr>
                        ...
                        <td>
                            <p data-placement="top" data-toggle="tooltip" title="Edit">
                                <a href="{{route('post.edit', $post->id)}}" class="btn btn-success btn-xs">
